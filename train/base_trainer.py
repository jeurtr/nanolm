...
from .loss import KDLoss, LMLoss
from .parallel import DsParallel
from .partition_utils import unwrap_model_for_generation
from .scheduler import LRScheduler, NoneLRScheduler, WarmupCosineAnnealingLRScheduler
from .tools import TrainerTools
from .train_configs import DsZero2Config, DsZero3Config, KDConfig, TrainConfig
from .utils import (
    autocast,
    set_seed,
)
...
class BaseTrainer:
    ...
    def _init_train_model_and_optim(self, initial_lr: float):
        ...
        self._check_freeze_model(model)
    ...
    def _get_eval_data(self) -> str | None:
