...
安全提示：此模块为向后兼容支持 .pkl 格式。.pkl 文件可以执行任意代码，
请仅加载来自可信来源的数据集。首选 .npy 格式，以 mmap_mode='r' 加载更安全。
"""

import csv
import json
import pickle  # nosec: .pkl 格式仅用于向后兼容，推荐 .npy
...
class SFTDataset(Dataset):
    ...
    def __init__(
        ...
        if image_tags_file_path:
            with open(image_tags_file_path) as f:
